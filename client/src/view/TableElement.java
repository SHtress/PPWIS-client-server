...
public class TableElement implements Serializable {
    ...
    private ArrayList<Student> defaultStudentList;
    ...
    public TableElement(ArrayList<Student> studentList, int examNumber) {
        ...
        ArrayList<TableColumn<Student, String>> examNumColList = new ArrayList<>();
        ArrayList<TableColumn<Student, String>> examScoreColList = new ArrayList<>();
    ...
    public void rewriteDefaultList(ArrayList<Student> list) {
    ...
    public void setObservableList(ArrayList<Student> list) {
